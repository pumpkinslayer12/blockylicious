...
<div <? echo $block_wrapper_attributes; ?>>
    <div class="curve top-curve"
        style="display: <? echo $attributes['enableTopCurve'] ? "block" : "none" ?>; transform: <? echo $topTransform; ?>; height: <? echo $attributes['topHeight'] ?>px;">
        <svg style="height: <? echo $attributes['topHeight'] ?>px; width: <? echo $attributes['topWidth'] ?>%"
            ...
            <path fill="<? echo $attributes['topColor'] ?? "white" ?>"
                d="<? echo $attributes['topFlipY'] ? $invertedPath : $normalPath; ?>"></path>
        </svg>
    </div>
    ...
    <div class="curve bottom-curve"
        style="z-index: 0; display: <? echo $attributes['enableBottomCurve'] ? "block" : "none" ?>; transform: <? echo $bottomTransform; ?>; height: <? echo $attributes['bottomHeight'] ?>px;">
        <svg style="height: <? echo $attributes['bottomHeight'] ?>px; width: <? echo $attributes['bottomWidth'] ?>%"
            ...
            <path fill="<? echo $attributes['bottomColor'] ?? "white" ?>"
                d="<? echo $attributes['bottomFlipY'] ? $invertedPath : $normalPath; ?>"></path>
        </svg>
    </div>
</div>